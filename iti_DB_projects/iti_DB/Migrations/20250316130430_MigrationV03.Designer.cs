...
namespace iti_DB.Migrations
{
    ...
    [Migration("20250316130430_MigrationV03")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iti_DB.models.Department", b =>
                {
                    b.HasOne("iti_DB.models.Instructor", "Manager_ins")
                        .WithOne("Manager_ins")
                        .HasForeignKey("iti_DB.models.Department", "Dept_Maneger")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("Manager_ins");
                });
